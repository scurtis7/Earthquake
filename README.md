...
Earthquake repository contains a server application and a client application to get data from USGS and display the data in the client.

The data comes from here [Earthquake Hazards Program](https://earthquake.usgs.gov/fdsnws/event/1/).

Here is an explanation of the [data](https://earthquake.usgs.gov/data/comcat/index.php).

## Stack

Earthquake applications are built on top of a few core technologies:
...
![Angular](https://img.shields.io/badge/Angular-0F0F11?logo=angular&logoColor=fff&style=plastic)
![PrimeNG](https://img.shields.io/badge/PrimeNG-DD0031?logo=primeng&logoColor=fff&style=plastic)
